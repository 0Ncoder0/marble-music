...
test("SC-002: performance gates — fps >= 55, predictionMs <= 100, timelineTrackCount >= 5", async ({ page }) => {
  ...
  await page.waitForFunction(() => (window.__debugState?.entityCount ?? 0) >= 25, { timeout: 10_000 });
