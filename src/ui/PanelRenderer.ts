...
export class PanelRenderer {
  ...
  constructor(container: HTMLElement) {
    ...
    wrapper.style.cssText =
      'display:flex;flex-direction:column;height:100%;padding:12px;gap:12px;overflow-y:auto;';
    ...
    toolTitle.style.cssText =
      'font-size:11px;color:#888;margin-bottom:8px;text-transform:uppercase;letter-spacing:1px;font-family:sans-serif;';
    ...
    this._paramPanel.style.cssText =
      'display:none;border-top:1px solid #2a2a4e;padding-top:12px;';

    const paramTitle = document.createElement('div');
    paramTitle.textContent = '♪ 音乐方块参数';
    paramTitle.style.cssText =
      'font-size:12px;font-weight:bold;color:#c9b3e8;margin-bottom:12px;font-family:sans-serif;';
    ...
    noteLabel.style.cssText =
      'display:block;font-size:12px;color:#aaa;margin-bottom:4px;font-family:sans-serif;';
    ...
    this._noteNameError.style.cssText =
      'display:none;font-size:11px;color:#e07070;margin-top:4px;font-family:sans-serif;';
    ...
    volLabel.style.cssText =
      'display:flex;justify-content:space-between;font-size:12px;color:#aaa;margin-bottom:4px;font-family:sans-serif;';
    ...
    hint.style.cssText =
      'font-size:11px;color:#666;margin-top:4px;font-style:italic;font-family:sans-serif;';
